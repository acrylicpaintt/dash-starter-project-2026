...
export class MenuBar extends React.Component<MenuBarProps> {
    ...
    createNewTextNode = () => {
        ...
        const newTextNode = new TextNodeStore({ 
            ...
            title: "Text Node #", //+ this.props.nodeCollection.count, //title: type of node + how many nodes there are
            text: "This is a newly created node!" 
        });

        this.state.currentCollection.addNodes([newTextNode]);
    }
    ...
    createNewImageNode = () => {
        ...
        this.state.currentCollection.addNodes([newImageNode]);
    };
    ...
    createNewCollectionNode = () => {
        ...
        this.state.currentCollection.addNodes([newNode]);
    };
